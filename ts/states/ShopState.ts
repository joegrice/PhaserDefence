class ShopState extends Phaser.State {
    ...
    create(): void {
        ...
        var moneyText: Phaser.Text = this.game.add.text(this.game.world.centerX, 150, "Money: " + GlobalState.money,
        ...
        for (let i: number = 0; i < GlobalState.towers.length; i++) {
            let btn: Phaser.Sprite = this.setUpShopItem((i + 1) * 150, GlobalState.towers[i].key);
